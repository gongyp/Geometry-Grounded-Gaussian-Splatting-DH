#!/usr/bin/env python
"""Simple test to verify ellipse_projection correctness."""
...
def main():
    ...
    # Test with increasing numbers of Gaussians
    for N in [1000, 5000, 10000, 50000]:
        ...
        pixels_covered = (actual_counts > 0).sum().item()
        ...
        print(f"  Max Gaussians per pixel: {actual_counts.max().item()}")
